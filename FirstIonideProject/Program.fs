...
let main argv =
    ...
    let multiABRec, maxCountRec = findBestCoefficientsRec 1000 1000 1000
    ...
    let multiABList, maxCountList = findBestCoefficientsRec 1000 1000 1000
    ...
    let multiABMap, maxCountMap = findBestCoefficientsRec 1000 1000 1000
    ...
    let multiABSeq, maxCountSeq = findBestCoefficientsRec 1000 1000 1000
